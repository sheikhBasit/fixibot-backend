...
def api_sign_request(params_to_sign, api_secret, algorithm=..., signature_version=...): # -> str:
    """
...
def api_string_to_sign(params_to_sign, signature_version=...): # -> LiteralString:
    """
...
def finalize_resource_type(resource_type, type, url_suffix, use_root_path, shorten): # -> tuple[Any | Literal['iu', 'images', 'files', 'image'] | None, Any | Literal['upload'] | None]:
    ...
...
def base_api_url(path, **options): # -> LiteralString:
    ...

def cloudinary_api_url(action=..., **options): # -> LiteralString:
    ...
...
PREDEFINED_VARS = ...
replaceRE = ...
def translate_if(match): # -> str | None:
    ...
...
def html_attrs(attrs, only=...): # -> LiteralString:
    ...
