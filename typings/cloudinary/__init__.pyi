...
class CloudinaryResource:
    ...
    def __init__(self, public_id=..., format=..., version=..., signature=..., url_options=..., metadata=..., type=..., resource_type=..., default_resource_type=...) -> None:
        ...
    ...
    def image(self, **options): # -> LiteralString:
        """
    ...
    def source(self, **options): # -> LiteralString:
        ...
